...
Simple documentation website about the digi-monsters api made with Astro using the [docs starter kit template Astro](https://github.com/withastro/astro/tree/main/examples/docs) provides.
